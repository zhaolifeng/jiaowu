...
(function($ns){
    ...
    $ns.keydownEvent = function(){
    	$ns.enterEvent();
    	$(document).bind("keydown",function(event){$ns.backspaceForbiden(event)});
    };
    /**
     * 回车键特殊处理
     */
    ...
    function movePage($title){
        ...
        $title.hover(function(){$(this).css("cursor","move");},function(){$(this).css("cursor","default");})
