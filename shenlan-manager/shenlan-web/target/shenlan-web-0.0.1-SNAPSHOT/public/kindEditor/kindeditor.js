...
K.options = {
	...
	items : [
		...
		'italic', 'underline', 'strikethrough', 'lineheight', 'removeformat', '|', 'image','insertvideo',
		 'table', 'hr','link','emoticons', 'unlink','insertfile'
	],
	...
	fontSizeTable : ['5px','6px','7px','8px','9px', '10px', '12px', '14px', '16px', '18px', '24px', '32px'],
	htmlTags : {
...
_extend(KCmd, {
	...
	insertinsertvideo : function(url, title, width, height, border, align) {
		title = _undef(title, '');
		border = _undef(border, 0);
		var html = '<span><center><video height="'+height+'" width="'+width+'" src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" controls="controls"></video></center></span><br/>';
		return this.inserthtml(html);
	},
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'body, td {font:4px/1.5 "sans serif",tahoma,verdana,helvetica;}',
...
_plugin('core', function(K) {
	...
	_each('link,image,flash,media,anchor,insertvideo'.split(','), function(i, name) {
