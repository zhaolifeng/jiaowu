	function show(title,content){
		...
		var left=leftScroll+(wWidth-404)/2;
			html+="<div class=\"window\" style=\"z-index:999999999;padding:2px; margin:2px; background:url('../message_util/setmessbg.gif') no-repeat scroll center top transparent; width:404px; height:158px;\">";
			html+="<div  style=\"width:369px; margin:0 auto; height:29px; padding-top:7px; overflow:hidden;\">";
			...
			html+="<dt style=\"display:block; margin:0; padding:0; width:50px; float:left;\"></dt>";
			...
			html+="<center><a  href=\"#\" onclick=\"ok();\" style=\"display:block; width:74px; height:27px; background:url(../message_util/enterbutt.gif) no-repeat; margin:13px 0 0 0px;\"></a></center>";
			html+="</dd>";
			html+="</dl>";
			html+="</div>";
			html+="</div>";
	...
	function warn(title,content){
		...
		html+="<div class=\"content\" style=\"width:369px; margin:0 auto; overflow:hidden;\">";
		html+="<dl style=\"display:block; width:369px; margin:0; padding:0; padding:15px 0 6px 0; float:left;\">";
		html+="<dt style=\"display:block; margin:0; padding:0; width:50px; float:left;\"><img src=\"../message_util/tanhao.gif\" /></dt>";
		html+="<dd style=\"margin:0; padding:0; font-size:14px;color:#333333; width:318px; float:left;\">";
		html+="<span style=\"display:block; line-height:28px;\">"+content+"</span>";
		html+="<center><a  href=\"#\" onclick=\"ok();\" style=\"display:block; width:74px; height:27px; background:url(../message_util/enterbutt.gif) no-repeat; margin:13px 0 0 0px;\"></a></center>";
		html+="</dd>";
