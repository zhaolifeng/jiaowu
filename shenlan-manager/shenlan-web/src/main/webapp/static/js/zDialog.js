 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '/shenlan/static/images/'; //图片路径配置
...
var $topWindow = function () {
    ...
    while (parentWin != parentWin.self) {
        if (parentWin.self.document.getElementsByTagName("FRAMESET").length > 0) break;
...
var Dialog = function () {
    ...
    this.MessageIcon = IMAGESPATH + "window.gif";
    this.MessageTitle = "";
    this.Message = "";
